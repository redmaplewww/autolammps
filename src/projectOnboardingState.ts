...
export function getSteps(): Step[] {
  const hasMemoryPrompt = getFsImplementation().existsSync(
    join(getCwd(), 'ANGSHENG.md'),
  )
  ...
  return [
    {
      key: 'workspace',
      text: 'Ask Angsheng to create a new app or clone a repository',
      isComplete: false,
      isCompletable: true,
    ...
    {
      key: 'memoryFiles',
      text: 'Run /init to create a ANGSHENG.md file with instructions for Claude',
      isComplete: hasMemoryPrompt,
      isCompletable: true,
      isEnabled: !isWorkspaceDirEmpty,
    },
  ]
