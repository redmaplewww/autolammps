...
/**
 * Loads markdown files from .angsheng/output-styles directories throughout the project
 * and from ~/.angsheng/output-styles directory and converts them to output styles.
 *
 ...
 *
 * Structure:
 * - Project .angsheng/output-styles/*.md -> project styles
 * - User ~/.angsheng/output-styles/*.md -> user styles (overridden by project styles)
 *
