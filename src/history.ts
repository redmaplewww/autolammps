...
import { getAppConfigHomeDir, isEnvTruthy } from './utils/envUtils.js'
...
/**
 * Angsheng parses history for pasted content references to match back to
...
export function addToHistory(command: HistoryEntry | string): void {
  // Skip history when running in a tmux session spawned by Angsheng's Tungsten tool.
