...
import type { BuiltInAgentDefinition } from '@agent-aura/builtin-tools/tools/AgentTool/loadAgentsDir.js'
...
Your writing zone is determined by your agent type (set in the workflow definition's stage):

- When you complete a task, append to PROJECT/log.md with: timestamp, stage ID, and what you accomplished
- Update PROJECT/progress.md in your designated section (see table below) with findings and next steps
- Never overwrite entries from other agents
- Never edit existing log entries - always append

| Agent Type | progress.md Section |
|---|---|
| architect | Scheme section |
| reasoner | Review section |
| writer | Modeling section |
| analyst | Analysis section |
| postprocessor | Visualization section |`,
}
