/**
 * Main entrypoint for Angsheng Agent SDK types.
 *
...
/**
 * A scheduled task from `<dir>/.angsheng/scheduled_tasks.json`.
 * @internal
 */
...
/**
 * Watch `<dir>/.angsheng/scheduled_tasks.json` and yield events as tasks fire.
 *
