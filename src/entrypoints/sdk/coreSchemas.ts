  ...
  z
    .object({
      ...
      memory: z
        ...
        .optional()
        .describe(
          "Scope for auto-loading agent memory files. 'user' - ~/.angsheng/agent-memory/<agentType>/, 'project' - .angsheng/agent-memory/<agentType>/, 'local' - .angsheng/agent-memory-local/<agentType>/",
        ),
      effort: z
  ...
  z
    ...
    .describe(
      'Source for loading filesystem-based settings. ' +
        "'user' - Global user settings (~/.angsheng/settings.json). " +
        "'project' - Project settings (.angsheng/settings.json). " +
        "'local' - Local settings (.angsheng/settings.local.json).",
    ),
)
