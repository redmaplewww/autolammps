 ...
 * user-controlled files (~/.angsheng/settings.json and ~/.claude.json),
 ...
 * (~/.angsheng/settings.json). These are user-controlled files that don't
...
function getExtraCertsPathFromConfig(): string | undefined {
  try {
    ...
    // Only read from user-controlled settings (~/.angsheng/settings.json),
