 ...
 * Excludes: ANGSHENG.md, ANGSHENG.local.md, .angsheng/rules/*.md (user-managed).
 *
...
export function isMemoryDirectory(dirPath: string): boolean {
  ...
  const configDirCmp = toComparable(getAppConfigHomeDir())
...
// Excludes ANGSHENG.md, ANGSHENG.local.md, .angsheng/rules/ (user-managed).
