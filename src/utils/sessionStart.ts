  ...
  if (shouldAllowManagedHooksOnly()) {
    ...
    try {
      ...
      if (
        ...
        userGuidance =
          'This appears to be a permissions issue. Check file permissions on ~/.angsheng/plugins/'
      } else if (
        ...
        userGuidance =
          'This appears to be a configuration issue. Check your plugin settings in .angsheng/settings.json'
      } else {
        userGuidance =
      ...
      // from .angsheng/settings.json (loaded via captureHooksConfigSnapshot) will still work
    }
  }
