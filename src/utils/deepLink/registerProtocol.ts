...
const APP_NAME = 'Angsheng URL Handler'
const DESKTOP_FILE_NAME = 'claude-code-url-handler.desktop'
const MACOS_APP_NAME = 'Angsheng URL Handler.app'
...
<dict>
  ...
  <array>
    <dict>
      ...
      <string>Angsheng Deep Link</string>
...
Name=${APP_NAME}
Comment=Handle ${DEEP_LINK_PROTOCOL}:// deep links for Angsheng
