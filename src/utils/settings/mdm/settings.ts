/**
 * MDM (Mobile Device Management) settings are disabled in this
 * project-isolated fork.
 */
...
export function startMdmSettingsLoad(): void {
  // Pure project isolation never reads OS-level managed settings.
...
/**
 * Read disabled MDM settings from the session cache.
 */
