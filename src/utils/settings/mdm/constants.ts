/**
 * Shared constants for disabled MDM settings modules.
 */

/** macOS preference domain for Angsheng MDM profiles. */
export const MACOS_PREFERENCE_DOMAIN = 'com.anthropic.claudecode'

/**
 * Windows registry key paths for Angsheng MDM policies.
 *
