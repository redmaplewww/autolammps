...
import { extractBashCommentLabel } from '@agent-aura/builtin-tools/tools/BashTool/commentLabel.js'
...
import { getReplPrimitiveTools } from '@agent-aura/builtin-tools/tools/REPLTool/primitiveTools.js'
import {
  type BranchAction,
  type CommitKind,
  detectGitOperation,
  type PrAction,
} from '@agent-aura/builtin-tools/tools/shared/gitOperationTracking.js'
...
const SNIP_TOOL_NAME = feature('HISTORY_SNIP')
  ? (
      require('@agent-aura/builtin-tools/tools/SnipTool/prompt.js') as typeof import('@agent-aura/builtin-tools/tools/SnipTool/prompt.js')
    ).SNIP_TOOL_NAME
  : null
