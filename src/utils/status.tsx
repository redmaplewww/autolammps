...
import { getAccountInformation, isWebAppSubscriber } from './auth.js'
import {
  getLargeMemoryFiles,
  getMemoryFiles,
...
export function getModelDisplayLabel(mainLoopModel: string | null): string {
  ...
  if (mainLoopModel === null && isWebAppSubscriber()) {
    const description = getWebAppUserDefaultModelDescription()
