 ...
 * 2. Default: ~/.angsheng/plugins or ~/.angsheng/cowork_plugins
 */
export function getPluginsDirectory(): string {
  ...
  // like "~/.angsheng/plugins" becomes a literal `~` directory created in the
  ...
  return join(getAppConfigHomeDir(), getPluginsDirectoryName())
}
