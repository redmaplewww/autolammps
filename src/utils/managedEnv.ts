 ...
 * user's ~/.angsheng/settings.json can't redirect requests away from the
 ...
 *
 * - userSettings (~/.angsheng/settings.json): controlled by the user, not project-specific
...
export function applySafeConfigEnvironmentVariables(): void {
  ...
  // doesn't get clobbered by ~/.angsheng/settings.json env (gh#217). policy/flag
