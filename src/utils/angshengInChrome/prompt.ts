export const BASE_CHROME_PROMPT = `# Angsheng in Chrome browser automation
...
/**
 * Minimal hint about Angsheng in Chrome skill availability. This is injected at startup when the extension is installed
