...
const DEFAULT_PREFIX = `You are Agent Aura, a terminal-first AI coding assistant.`
const AGENT_SDK_CLAUDE_CODE_PRESET_PREFIX = `You are Agent Aura, a terminal-first AI coding assistant, running within the Claude Agent SDK.`
const AGENT_SDK_PREFIX = `You are an ANGSHENG agent.`
