export const PRODUCT_URL = 'https://github.com/anthropics/claude-code'

// Angsheng Remote session URLs
export const CLAUDE_AI_BASE_URL = 'https://angsheng.dev'
export const CLAUDE_AI_STAGING_BASE_URL = 'https://angsheng-staging.dev'
...
export function getRemoteSessionUrl(
  ...
  const baseUrl = getWebAppBaseUrl(compatId, ingressUrl)
