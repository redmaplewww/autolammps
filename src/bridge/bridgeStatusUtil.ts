import { getWebAppBaseUrl } from '../constants/product.js'
...
export function buildBridgeConnectUrl(
  ...
  const baseUrl = isSelfHostedBridge()
    ? getBridgeBaseUrl()
    : getWebAppBaseUrl(undefined, ingressUrl)
