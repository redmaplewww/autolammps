...
} from '../../utils/plugins/manifestPaths.js'
    ...
    async function runValidation() {
      ...
      if (!path) {
        onComplete(
            ...
            'Examples:\n' +
            `  /plugin validate ${getDefaultPluginManifestRelativePath()}\n` +
            '  /plugin validate /path/to/plugin-directory\n' +
            '  /plugin validate .\n\n' +
            `When given a directory, automatically validates ${getDefaultMarketplaceManifestRelativePath()}\n` +
            `or ${getDefaultPluginManifestRelativePath()} (prefers marketplace if both exist).\n\n` +
