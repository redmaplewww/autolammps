  ...
  React.useEffect(() => {
    async function handleModelChange(): Promise<void> {
      ...
      if (model && isOpus1mUnavailable(model)) {
        onDone(
          `High Powered Plus is not available for your account. Learn more: https://code.claude.com/docs/en/model-config#extended-context-with-1m`,
          { display: 'system' },
        )
        return
      }
      ...
      if (model && isSonnet1mUnavailable(model)) {
        onDone(
          `Medium Powered Plus is not available for your account. Learn more: https://code.claude.com/docs/en/model-config#extended-context-with-1m`,
          { display: 'system' },
        )
        return
      }
