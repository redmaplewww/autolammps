...
import { useSubscriptionLimits } from '../../services/subscriptionLimitsHook.js'
...
import { hasWebAppBillingAccess } from '../../utils/billing.js'
  ...
  >(() => {
    ...
    if (extraUsage.isEnabled()) {
      ...
      const isOrgSpendCapDepleted =
        subscriptionLimits.overageDisabledReason === 'out_of_credits' ||
        subscriptionLimits.overageDisabledReason === 'org_level_disabled_until' ||
        subscriptionLimits.overageDisabledReason === 'org_service_zero_credit_limit'
      ...
      if (needsToRequestFromAdmin && isOrgSpendCapDepleted) {
        ...
        const isOverageState =
          subscriptionLimits.overageStatus === 'rejected' ||
          subscriptionLimits.overageStatus === 'allowed_warning'
    ...
    subscriptionLimits.overageStatus,
    subscriptionLimits.overageDisabledReason,
  ])
