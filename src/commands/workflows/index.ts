...
import { getWorkflowCommands } from '@agent-aura/builtin-tools/tools/WorkflowTool/createWorkflowCommand.js'
...
const call: LocalCommandCall = async (_args, _context) => {
  ...
  if (commands.length === 0) {
    return {
      type: 'text',
      value: 'No workflows found. Add workflow files to .angsheng/workflows/ (YAML or Markdown).',
    }
  }
