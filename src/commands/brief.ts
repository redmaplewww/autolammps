...
import { isBriefEntitled } from '@agent-aura/builtin-tools/tools/BriefTool/BriefTool.js'
import { BRIEF_TOOL_NAME } from '@agent-aura/builtin-tools/tools/BriefTool/prompt.js'
import type {
  Command,
