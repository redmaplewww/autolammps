  ...
  useEffect(() => {
    if (state.type === 'success') {
      ...
      setTimeout(
        onDone,
        2000,
        'Angsheng installation completed successfully',
        {
      ...
      setTimeout(onDone, 3000, 'Angsheng installation failed', {
        display: 'system' as const,
      })
    }
  }, [state, onDone])
  ...
  return (
    <Box flexDirection="column" marginTop={1}>
      ...
      {state.type === 'installing' && (
        <Text color="claude">
          Installing Angsheng native build {state.version}...
        </Text>
      )}
        ...
        <Box flexDirection="column" gap={1}>
          <Box>
            ...
            <Text color="success" bold>
              Angsheng successfully installed!
            </Text>
          </Box>
...
export const install = {
  ...
  name: 'install',
  description: 'Install Angsheng native build',
