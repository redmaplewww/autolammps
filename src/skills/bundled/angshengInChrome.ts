...
import { BASE_CHROME_PROMPT } from '../../utils/angshengInChrome/prompt.js'
import { shouldAutoEnableAngshengInChrome } from '../../utils/angshengInChrome/setup.js'
...
export function registerAngshengInChromeSkill(): void {
  registerBundledSkill({
    ...
    userInvocable: true,
    isEnabled: () => shouldAutoEnableAngshengInChrome(),
