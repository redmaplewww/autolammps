...
// anthropicApiContent.js bundles 247KB of .md strings. Lazy-load inside
// getPromptForCommand so they only enter memory when /claude-api is invoked.
type SkillContent = typeof import('./anthropicApiContent.js')
...
export function registerClaudeApiSkill(): void {
  registerBundledSkill({
    ...
    async getPromptForCommand(args) {
      const content = await import('./anthropicApiContent.js')
