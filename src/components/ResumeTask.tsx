    ...
    return (
      <Box flexDirection="column" padding={1}>
        <Box flexDirection="row">
          <Spinner />
          <Text bold>Loading Agent Aura sessions…</Text>
        </Box>
        <Text dimColor>
          {retrying ? 'Retrying…' : 'Fetching your Agent Aura sessions…'}
        </Text>
      </Box>
    )
  }
    ...
    return (
      <Box flexDirection="column" padding={1}>
        <Text bold color="error">
          Error loading Agent Aura sessions
        </Text>
...
function renderErrorSpecificGuidance(
  ...
  switch (errorType) {
    ...
    case 'auth':
      return (
        <Box marginY={1} flexDirection="column">
          <Text dimColor>Teleport requires a subscription account</Text>
          <Text dimColor>
            Run <Text bold>/login</Text> and select &quot;subscription account with
            subscription&quot;
          </Text>
        </Box>
      )
    ...
    case 'other':
      return (
        <Box marginY={1} flexDirection="row">
          <Text dimColor>Sorry, Agent Aura encountered an error</Text>
        </Box>
      )
  }
}
