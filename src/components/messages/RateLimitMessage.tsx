...
export function RateLimitMessage({
  ...
  const shouldShowUpsell = shouldProcessMockLimits() || isWebAppSubscriber()
  ...
  const isCurrentlyRateLimited =
    subscriptionLimits.status === 'rejected' &&
    subscriptionLimits.resetsAt !== undefined &&
  ...
  const upsell = useMemo(() => {
    const message = getUpsellMessage({
      ...
      isTeamOrEnterprise,
      hasBillingAccess: hasWebAppBillingAccess(),
    })
