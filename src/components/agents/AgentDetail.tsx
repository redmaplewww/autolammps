...
import { getAgentColor } from '@agent-aura/builtin-tools/tools/AgentTool/agentColorManager.js'
import { getMemoryScopeDisplay } from '@agent-aura/builtin-tools/tools/AgentTool/agentMemory.js'
