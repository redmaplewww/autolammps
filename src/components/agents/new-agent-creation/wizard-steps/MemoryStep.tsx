...
export function MemoryStep(): ReactNode {
  ...
  const memoryOptions: MemoryOption[] = isUserScope
    ? [
        {
          label: 'User scope (~/.angsheng/agent-memory/) (Recommended)',
          value: 'user',
        },
        { label: 'None (no persistent memory)', value: 'none' },
        { label: 'Project scope (.angsheng/agent-memory/)', value: 'project' },
        { label: 'Local scope (.angsheng/agent-memory-local/)', value: 'local' },
      ]
    : [
        {
          label: 'Project scope (.angsheng/agent-memory/) (Recommended)',
          value: 'project',
        },
        { label: 'None (no persistent memory)', value: 'none' },
        { label: 'User scope (~/.angsheng/agent-memory/)', value: 'user' },
        { label: 'Local scope (.angsheng/agent-memory-local/)', value: 'local' },
      ]
