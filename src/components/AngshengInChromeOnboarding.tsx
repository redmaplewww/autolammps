...
export function AngshengInChromeOnboarding({ onDone }: Props): React.ReactNode {
  ...
  React.useEffect(() => {
    ...
    saveGlobalConfig(current => {
      return { ...current, hasCompletedAngshengInChromeOnboarding: true }
    })
  }, [])
    ...
    >
      <Box flexDirection="column" gap={1}>
        <Text>
          ...
          your browser directly from Agent Aura. You can navigate websites,
