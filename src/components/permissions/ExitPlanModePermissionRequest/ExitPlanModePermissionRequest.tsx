...
import type { AllowedPrompt } from '@agent-aura/builtin-tools/tools/ExitPlanModeTool/ExitPlanModeV2Tool.js'
    ...
    return (
      ...
      >
        <Box flexDirection="column" paddingX={1} marginTop={1}>
          <Text>Angsheng wants to exit plan mode</Text>
          <Box marginTop={1}>
            <Select
              options={[
...
export function buildPlanApprovalOptions({
  ...
  if (showUltraplan) {
    options.push({
      label: 'No, refine with Ultraplan on Agent Aura on the web',
      value: 'ultraplan',
    })
  }
  ...
  options.push({
    ...
    value: 'no',
    placeholder: 'Tell Angsheng what to change',
