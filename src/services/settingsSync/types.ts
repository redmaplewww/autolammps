...
export const SYNC_KEYS = {
  USER_SETTINGS: '~/.angsheng/settings.json',
  USER_MEMORY: '~/.angsheng/ANGSHENG.md',
  projectSettings: (projectId: string) =>
    `projects/${projectId}/.angsheng/settings.local.json`,
  projectMemory: (projectId: string) => `projects/${projectId}/ANGSHENG.local.md`,
} as const
