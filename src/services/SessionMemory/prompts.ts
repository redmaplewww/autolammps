...
- Do not include information that's already in the ANGSHENG.md files included in the context
 ...
 * Custom prompts can be placed at ~/.angsheng/session-memory/prompt.md
