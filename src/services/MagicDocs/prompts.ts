...
- Information already in ANGSHENG.md or other project docs
 ...
 * Custom prompts can be placed at ~/.angsheng/magic-docs/prompt.md
...
async function loadMagicDocsPrompt(): Promise<string> {
  ...
  const promptPath = join(getAppConfigHomeDir(), 'magic-docs', 'prompt.md')
