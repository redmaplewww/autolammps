...
| 17 | Angsheng in Chrome Bridge | `bridge.claudeusercontent.com` | WSS | Chrome 集成 |
...
- **文件**: `src/services/api/client.ts`, `src/services/api/anthropic.ts`
...
| `/v1/organizations/{id}/mcp_servers` | 组织 MCP 配置 | `src/services/mcp/webAppMcp.ts` |
