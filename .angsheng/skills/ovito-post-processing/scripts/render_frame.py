"""Render one OVITO frame as a selected standard view or all standard views."""
...
def main() -> None:
    ...
    parser.add_argument(
        "--view",
        choices=("front", "side", "top", "iso", "diag_xy", "diag_xz", "all"),
        default="all",
    )
    ...
    if args.view == "all":
        ...
        engine.render_view(view=args.view, prefix=args.prefix, zoom_method=zoom_method)
