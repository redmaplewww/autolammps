...
| `--resume` | Resume previous session from `.angsheng/skills/teach-me/records/{topic-slug}/` |
...
All teach-me data is stored under `.angsheng/skills/teach-me/records/`:

```
.angsheng/skills/teach-me/records/
...
3. Load learner profile if `.angsheng/skills/teach-me/records/learner-profile.md` exists.
...
5. Create output directory: `.angsheng/skills/teach-me/records/{topic-slug}/`
...
2. Update `.angsheng/skills/teach-me/records/learner-profile.md` (keep under 30 lines):
