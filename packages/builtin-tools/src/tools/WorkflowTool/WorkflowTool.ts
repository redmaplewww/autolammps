...
export const WorkflowTool = buildTool({
  ...
  async description() {
    return 'Execute a user-defined workflow script from .angsheng/workflows/'
  },
  async prompt() {
    return `Use the Workflow tool to execute user-defined workflow scripts located in .angsheng/workflows/. Workflows are YAML or Markdown files that define a sequence of steps for common development tasks.

Guidelines:
- Specify the workflow name to execute (must match a file in .angsheng/workflows/)
