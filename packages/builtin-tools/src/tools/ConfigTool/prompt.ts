...
export const DESCRIPTION = 'Get or set Angsheng configuration settings.'
...
export function generatePrompt(): string {
  ...
  return `Get or set Angsheng configuration settings.

  View or change Angsheng settings. Use when the user requests configuration changes, asks about current settings, or when adjusting a setting would benefit them.
